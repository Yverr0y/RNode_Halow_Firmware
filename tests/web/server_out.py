...
WWW_DIR = Path(__file__).parent.parent.parent / "out" / "_filesystem" / "www"
...
class Handler(BaseHTTPRequestHandler):
    ...
    def _serve_static(self):
        ...
        # Try Brotli-compressed version first if requesting index.html
        if rel == "index.html":
            br_target = WWW_DIR / "index.html.br"
            if br_target.exists():
                target = br_target
